package com.engineeringdigest.CyclicBarrier_18;

import java.util.concurrent.BrokenBarrierException;
import java.util.concurrent.CyclicBarrier;
/*CyclicBarrier is a synchronization aid that allows a fixed number of threads
 *to wait at a common barrier point until all threads have reached that point.
Once all threads arrive, the barrier is broken and all threads are released.
 * */
public class Main {
