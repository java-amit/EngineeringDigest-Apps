package com.engineeringdigest.deadlock_12;
class Pen {
...
class Task2 implements Runnable {
    ...
    @Override
    public void run() {
        synchronized (pen){  //***[solution of dead lock: use synchronization keyword] pahle pen pr lock chahte hai hm, ham task 2 se kh denge ki pahle pen ka lock laiye then aap paper ka lock request kriye.(change order of lock)
